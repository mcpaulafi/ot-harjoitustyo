...
class TestObservationService(unittest.TestCase):
    ...
    def test_get_observation(self):
        ...
        get_obs = self._observation_repository.find_observation(station_id)
        test_id = 20
        for n in get_obs:
            if n.station_id == station_id:
                test_id = n.station_id

        return self.assertEqual(test_id, 1)
    ...
    def test_update_observation(self):
        ...
        get_name = self._observation_repository.find_observation(station_id)
        test_id = 20
        for n in get_name:
            if n.station_id == station_id:
                test_id = n.station_id
